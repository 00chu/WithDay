 ...
 * Java/프론트 응답에서는 enum 이름(PENDING, APPROVED, REJECTED, CANCELLED, KICKED)을 기준으로 비교한다.
 */
public enum ParticipationStatus {
     ...
     * 취소 상태는 미국식 CANCELED와 영국식 CANCELLED가 섞일 수 있어서 둘 다 CANCELLED enum으로 보정한다.
     */
     ...
     * CANCELLED enum도 기존 DB 스키마와 호환되도록 "canceled"로 저장한다.
     */
    ...
    /*
     * 참여 상태 전이 규칙이다.
     * PENDING은 승인/거절/취소로 갈 수 있고, APPROVED는 승인 취소(CANCELLED)만 가능하다.
